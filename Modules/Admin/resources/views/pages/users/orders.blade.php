...
@section('user-info')
    ...
    <form action="{{ route('admin.users.orders', request()->id) }}" method="get" id="searchForm">
        <div class="row">
            <div class="col-auto">
            ...
            <div class="col-auto">
                <div class="form-group">
                    <label class="mt-2 d-flex" for="priceFrom">Order total price from</label>
            ...
            <div class="col-auto">
                <div class="form-group">
                    <label class="mt-2 d-flex" for="priceTo">Order total price to</label>
        ...
        <div class="row">
            <div class="col-auto">
                <div class="form-group">
                    <label class="mt-2 d-flex" for="shipping_method_id">Shipping methods</label>
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="col-auto">
                    <button name="clear" type="button" class="btn btn-success"
                        onclick="common.clearSearchResult('{{ route('admin.users.orders', request()->id) }}')">
